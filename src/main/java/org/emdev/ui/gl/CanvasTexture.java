...
// The subclasses should override onDrawBitmap() to draw on the bitmap.
...
abstract class CanvasTexture extends UploadedTexture {
	...
	abstract protected void onDrawBitmap(Canvas canvas, Bitmap backing);
}
